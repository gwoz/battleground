...
150.times { Geolocation.create({user_id: user_ids.sample, lonlat: "POINT (#{-122.02639735} #{37.33020503})"}) }
...
#   Task.create(task)
# end
Task.create(title: 'Quick Draw', description: 'Click the button first to win.')
puts 'Added task'
